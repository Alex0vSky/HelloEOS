...
class Greeter final {
 public:
  ...
  class Stub final : public StubInterface {
   public:
	// to avoid error incremental link
	// helloworld::Greeter::Stub::\`vector deleting destructor'(unsigned int)" was previously strong but is now weak; performing full link
	virtual ~Stub() {}
