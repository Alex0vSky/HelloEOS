...
struct Networking {
	...
	static_assert( 1 == sizeof( Networking::messageData_t::value_type ), "support only single byte type" );
...
//	1170(0x492), EOS_EResult::EOS_LimitExceeded=22, [LogEOSP2P] Attempted to send a packet that was too large. LocalUserId=[000...6e2] RemoteUserId=[000...7e5] SocketId=[CHAT] PacketSize=[4096/1170]
